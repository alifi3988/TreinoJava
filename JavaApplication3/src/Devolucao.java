...
public class Devolucao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Estado do livro");

        jRadioButton1.setText("Okay");
        ...
        jRadioButton3.setText("Devolução do livro");
        ...
        jRadioButton4.setText("Adicionar mais prazo para entrega");
        ...
        getAccessibleContext().setAccessibleName("Devolução de livro");
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
                   JOptionPane.showMessageDialog(null,"Devolução realizada com sucesso ","Confirmação", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void setIcon() {
                ...
                setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("devolucao.png")));
